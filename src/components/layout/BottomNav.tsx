...
export const BottomNav: React.FC = () => {
  return (
    <nav className="bottom-nav">
      ...
      <div className="nav-item nav-item-scanner-wrapper">
        <NavLink 
          to="/escanear" 
          className="nav-item-scanner"
        ...
        <span style={{ height: '18px' }}></span> {/* Spacer to balance height */}
        <span style={{ fontSize: '11px', color: '#a89aa0', marginTop: '16px' }}>Escanear</span>
      </div>
